...
function allrgb_fea = allrgb_features1(N, rgb_image, segments)
    ...
    % for i = 1:size(training_matrix, 1)
        ...
        feature = [gray_mean, gray_std, idw_mean, energy, hist_mean, hist_variance, ...
                   hist_skewness, hist_kurtosis, hist_mode, hist_median, hist_slope];
